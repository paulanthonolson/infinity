...
public abstract class AbstractTree<E> implements TreeInterface<E> {
    ...
    private void preorderSubtree(Position<E> p, PositionalList<Position<E>> snapshot) {
        snapshot.addLast(p); // for preorder, we add position p before exploring subtrees
        for (Position<E> c : children(p))
    ...
    private void postorderSubtree(Position<E> p, PositionalList<Position<E>> snapshot) {
        ...
        snapshot.addLast(p); // for postorder, we add position p after exploring subtrees
    }
    ...
    public Iterable<Position<E>> breadthfirst() {
        PositionalList<Position<E>> snapshot = new LinkedPositionalList<>();
        if (!isEmpty()) {
            QueueInterface<Position<E>> fringe = new LinkedQueue<>();
