// Although not required to solve this problem, you are allowed to edit this
// CircularlyLinkedList and add a version of any of the methods we implemented
// in EnhancedSinglyLinkedList during Lab3b. The method signature should be
// the same, but the logic inside that method will need to be adjusted based
// on differences in how CircularlyLinkedList is implemented.
...
public class CircularlyLinkedList<E> {
    ...
    /**
     * returns (but does not remove) the second element
     *
     * @return second element or null if the list is empty
     */
    public E second() {
        if (size < 2) {
            return null;
    ...
    /**
     * returns (but does not remove) the middle element
     *
     * @return middle element or null if the list is empty
     */
    public E middle() {
        Node<E> walk;
