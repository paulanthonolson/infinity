...
public class Player_PaulOlson
{
	 ...
	 */
	public Player_PaulOlson(String playerName_initial, int health_initial, 
	...
	//Equals method
	public boolean equals(Player_PaulOlson player_obj) 
	{
		if 
		( 
